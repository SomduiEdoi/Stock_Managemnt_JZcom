...
- ข้อมูลต้นทางจาก SharePoint คือ `src/data/Network.csv` และ `src/data/Server.csv`
...
- Import source files: `src/data/Network.csv` และ `src/data/Server.csv`
...
- Domain ไม่ต้องให้ผู้ใช้ map เองใน MVP: `src/data/Network.csv` map เป็น Network และ `src/data/Server.csv` map เป็น Server
